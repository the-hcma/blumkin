...
class GoogleWorkspaceProvider:
    ...
    async def drive_export(self, *, item_id: str, to: str) -> dict[str, Any]:
        return await google_drive.drive_export(item_id=item_id, to=to, config=self._config)
    ...
    async def drive_move(
        ...
        *,
        ...
        return await google_drive.drive_move(
            item_id=item_id,
    ...
    async def drive_read(self, *, item_id: str) -> dict[str, Any]:
        return await google_drive.drive_read(item_id=item_id, config=self._config)
