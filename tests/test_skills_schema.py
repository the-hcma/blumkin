...
_ENUM_VALUES = {
    ...
    ("mail.mark", "--importance"): ["high", "normal", "low"],
...
_CONSENT = {
    ...
    "calendar.list": (False, False),
    "calendar.suggest": (False, False),
    "calendar.tentative": (True, True),
    ...
    "chat.draft": (True, False),
    "chat.edit": (True, True),
    "chat.edit-draft": (True, False),
    ...
    "drive.mkdir": (True, False),
    "drive.move": (True, False),
    "drive.read": (False, False),
    "drive.rename": (True, False),
    ...
    "mail.delete": (True, False),
    "mail.get": (False, False),
    "mail.inbox": (False, False),
    "mail.list": (False, False),
    "mail.mark": (True, False),
    "mail.move": (True, False),
    "mail.reply": (True, False),
    "mail.search": (False, False),
    "mail.signature": (False, False),
